...
void main() {
  ...
  // own clock widget. (Look in neon_lights_clock.dart for more details!)
  runApp(ClockCustomizer((ClockModel model) => NeonLightsClock(model)));
}
